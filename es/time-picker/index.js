...
var TimePicker = function (_Component) {
    ...
    function TimePicker(props) {
        ...
        _this.renderTimePicker = function (locale) {
            ...
            var prefixCls = getPrefixCls('time-picker', props.prefixCls);
            var format = _this.getDefaultFormat();
            var className = classNames(props.className, _defineProperty({}, prefixCls + '-' + props.size, !!props.size));
            ...
            return React.createElement(RcTimePicker, _extends({}, generateShowHourMinuteSecond(format), props, { prefixCls: prefixCls, ref: _this.saveTimePicker, format: format, className: className, value: _this.state.value, placeholder: props.placeholder === undefined ? locale.placeholder : props.placeholder, onChange: _this.handleChange, onOpen: _this.handleOpenClose, onClose: _this.handleOpenClose, addon: addon }));
        };
