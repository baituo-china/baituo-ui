...
var RangePicker = function (_Component) {
    ...
    _createClass(RangePicker, [{
        ...
        value: function render() {
            ...
            var clearIcon = !props.disabled && props.allowClear && value && (value[0] || value[1]) ? React.createElement(Button, { shape: 'circle', size: "small" /* small */, onClick: this.clearSelection, className: prefixCls + '-picker-clear', icon: 'close' }) : null;
