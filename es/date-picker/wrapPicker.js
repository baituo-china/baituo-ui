    ...
    return _a = function (_Component) {
        ...
        function PickerWrapper() {
            ...
            _this.renderPicker = function (locale, localeCode) {
                ...
                var pickerWrapperInputClass = classNames(inputPrefixCls + '-wrapper', (_classNames3 = {}, _defineProperty(_classNames3, inputPrefixCls + '-disabled', props.disabled), _defineProperty(_classNames3, inputPrefixCls + '-has-border', props.border), _classNames3));
