...
var Mention = function (_Component) {
    ...
    _createClass(Mention, [{
        ...
        value: function render() {
            ...
            return React.createElement(RcMention, _extends({}, this.props, { prefixCls: prefixCls, className: cls, ref: this.mentionRef, onSearchChange: this.onSearchChange, onChange: this.onChange, onFocus: this.onFocus, onBlur: this.onBlur, suggestions: suggestions, notFoundContent: notFoundContent }));
        }
    }]);
