...
var FilterMenu = function (_Component) {
    ...
    function FilterMenu(props) {
        ...
        _this.setNeverShown = function (column) {
            ...
            var filterBelongToScrollBody = !!closest(rootNode, _this.props.prefixCls + '-scroll');
    ...
    _createClass(FilterMenu, [{
        ...
        value: function renderMenuItem(item) {
            ...
            var input = multiple ? null : React.createElement(Radio, { checked: this.state.selectedKeys.indexOf(item.value.toString()) >= 0 });
