...
var FilterSelect = function (_Component) {
    ...
    function FilterSelect() {
        ...
        _this.getRootDomNode = function () {
            return findDOMNode(_this).querySelector('.' + getPrefixCls('select') + '-search__field');
        };
        return _this;
    }
                ...
                if (filters) {
                    return filters.filter(function (filter) {
                        ...
                        if (filterMultiple && columnKey) {
                            ...
                            text = [React.createElement(Checkbox, { key: 'ck', className: 'multiple', checked: _checked.indexOf(value) !== -1 }), text];
                        }
                        return React.createElement(
                            Option,
                    ...
                    }).concat(filterMultiple ? React.createElement(
                        OptGroup,
                        { key: 'ok' },
                        React.createElement(
                            Option,
