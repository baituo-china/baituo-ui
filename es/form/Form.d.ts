import React, { Component, ComponentClass, CSSProperties, FormEventHandler, ReactNode, SFC } from 'react';
...
export declare type ValidateCallback = (errors: any, values: any, modify?: boolean) => void;
...
export default class Form extends Component<FormProps, any> {
    ...
    static propTypes: {
        ...
        layout: PropTypes.Requireable<FormLayout>;
