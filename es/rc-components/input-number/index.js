...
var InputNumber = function (_Component) {
  ...
  _createClass(InputNumber, [{
    ...
    value: function render() {
      ...
      var classes = classNames((_classNames = {}, _defineProperty(_classNames, prefixCls, true), _defineProperty(_classNames, props.className, !!props.className), _classNames));
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderSuffix = function () {
    ...
    if (useTouch) {
      upEvents = {
        onTouchStart: editable && !upDisabledClass ? _this3.up : noop,
        onTouchEnd: _this3.stop
      };
      downEvents = {
        onTouchStart: editable && !downDisabledClass ? _this3.down : noop,
        onTouchEnd: _this3.stop
      };
    } else {
      upEvents = {
        onMouseDown: editable && !upDisabledClass ? _this3.up : noop,
        onMouseUp: _this3.stop,
        onMouseLeave: _this3.stop
      };
      downEvents = {
        onMouseDown: editable && !downDisabledClass ? _this3.down : noop,
        onMouseUp: _this3.stop,
        onMouseLeave: _this3.stop
      };
    }
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        _this3.props.upHandler || React.createElement(Icon, {
          unselectable: 'unselectable',
      ...
      React.createElement(
        ...
        _this3.props.downHandler || React.createElement(Icon, {
          unselectable: 'unselectable',
