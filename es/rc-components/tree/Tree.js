...
import { arrAdd, arrDel, calcCheckedKeys, calcDropPosition, calcExpandedKeys, calcSelectedKeys, getDragNodesKeys, getFullKeyList, getPosition, getStrictlyValue, posToArr, traverseTreeNodes } from './util';
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getSyncProps = function () {
    ...
    if (prevProps && checkSync('children')) {
      var _ref6 = calcCheckedKeys(props.checkedKeys || _this2.state.checkedKeys, props) || {},
