...
import { argumentContainer, flattenArray, getParams, getValidateTriggers, getValueFromEvent, hasRules, identity, isEmptyObject, normalizeValidateRules } from './utils';
    ...
    var Form = createReactClass({
      ...
      getFieldDecorator: function getFieldDecorator(name, fieldOption) {
        ...
        return function (fieldElem) {
          ...
          return cloneElement(fieldElem, _extends({}, props, _this2.fieldsStore.getFieldValuePropValue(fieldMeta)));
        };
      },
      ...
      validateFieldsInternal: function validateFieldsInternal(fields, _ref, callback) {
        ...
        if (callback && isEmptyObject(allFields)) {
          callback(isEmptyObject(alreadyErrors) ? null : alreadyErrors, this.fieldsStore.getFieldsValue(fieldNames), this.fieldsStore.isModifiedFields(fieldNames));
          return;
        }
        ...
        validator.validate(allValues, options, function (errors) {
          ...
          if (callback) {
            ...
            callback(isEmptyObject(errorsGroup) ? null : errorsGroup, _this6.fieldsStore.getFieldsValue(fieldNames), _this6.fieldsStore.isModifiedFields(fieldNames));
          }
        });
      },
