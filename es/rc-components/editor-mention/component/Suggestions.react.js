...
var Suggestions = function (_Component) {
  ...
  _createClass(Suggestions, [{
    ...
    value: function render() {
      ...
      var cls = cx(_extends((_extends2 = {}, _defineProperty(_extends2, prefixCls + '-dropdown', true), _defineProperty(_extends2, prefixCls + '-dropdown-placement-' + placement, true), _extends2), className));
