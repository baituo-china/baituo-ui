  ...
  _createClass(Pagination, [{
    ...
    value: function render() {
      ...
      if (props.simple) {
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            props.itemRender(prevPage, 'prev', React.createElement('a', { className: prefixCls + '-item-link' }), !this.hasPrev(), 'small')
          ),
          React.createElement(
            'li',
            {
          ...
          React.createElement(
            ...
            props.itemRender(nextPage, 'next', React.createElement('a', { className: prefixCls + '-item-link' }), !this.hasNext(), 'small')
          ),
          gotoButton
        );
      }
      ...
      if (allPages <= 5 + pageBufferSize * 2) {
        ...
        if (props.showPrevNextJumpers) {
          jumpPrev = React.createElement(
            ...
            props.itemRender(this.getJumpPrevPage(), 'jump-prev', React.createElement(
              'a',
          ...
          jumpNext = React.createElement(
            ...
            props.itemRender(this.getJumpNextPage(), 'jump-next', React.createElement(
              'a',
              { className: prefixCls + '-item-link' },
              '\u2022\u2022\u2022'
            ), props.size)
      ...
      if (props.tiny) {
        ...
        firstPager = React.createElement(
          'li',
          {
          ...
          props.itemRender(1, 'first', React.createElement('a', { className: prefixCls + '-item-link' }), fistDisabled, props.size)
        );
        lastPager = React.createElement(
          'li',
          {
          ...
          props.itemRender(allPages, 'last', React.createElement('a', { className: prefixCls + '-item-link' }), lastDisabled, props.size)
        );
      }
      var prevDisabled = !this.hasPrev();
      var nextDisabled = !this.hasNext();
      var sizeChanger = React.createElement(Options, {
        locale: props.locale,
        rootPrefixCls: prefixCls,
      ...
      var classString = classNames(prefixCls, props.className, _defineProperty({}, prefixCls + '-tiny', props.tiny));
      return React.createElement(
        'ul',
        {
        ...
        React.createElement(
          ...
          props.itemRender(prevPage, 'prev', React.createElement('a', { className: prefixCls + '-item-link' }), prevDisabled, props.size)
        ),
        ...
        React.createElement(
          ...
          props.itemRender(nextPage, 'next', React.createElement('a', { className: prefixCls + '-item-link' }), nextDisabled, props.size)
        ),
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.last = function () {
    if (_this2.hasNext()) {
      _this2.handleChange(_this2.calculatePage());
    }
  };
  ...
  this.runIfEnterFirst = function (e) {
    _this2.runIfEnter(e, _this2.first);
  };

  this.runIfEnterLast = function (e) {
    _this2.runIfEnter(e, _this2.last);
  };
