...
var TransferList = function (_Component) {
    ...
    function TransferList() {
        ...
        var _this = _possibleConstructorReturn(this, (TransferList.__proto__ || Object.getPrototypeOf(TransferList)).apply(this, arguments));
        ...
        _this.handleFilter = function (e) {
            ...
            _this.triggerScrollTimer = window.setTimeout(function () {
                var listNode = findDOMNode(_this).querySelectorAll(_this.props.prefixCls + '-content')[0];
                if (listNode) {
