    ...
    _createClass(UploadList, [{
        ...
        value: function render() {
            ...
            var list = items.map(function (file) {
                ...
                var progress = void 0;
                var icon = React.createElement(Icon, { type: file.status === 'uploading' ? 'loading' : 'attach_file' });
                if (listType === 'picture' || listType === 'picture-card') {
                    if (listType === 'picture-card' && file.status === 'uploading') {
                        ...
                        var thumbnail = isImageUrl(file.thumbUrl || file.url) ? React.createElement('img', { src: file.thumbUrl || file.url, alt: file.name }) : React.createElement(Icon, { type: 'file', style: { fontSize: 48, color: 'rgba(0,0,0,0.5)' } });
                        icon = React.createElement(
                            'a',
                ...
                if (file.status === 'uploading') {
                    ...
                    var loadingProgress = 'percent' in file ? React.createElement(Progress, _extends({ type: "line" /* line */ }, _this3.props.progressAttr, { percent: file.percent })) : null;
                ...
                var previewIcon = showPreviewIcon ? React.createElement(
                    ...
                    React.createElement(Icon, { type: 'visibility' })
                ) : null;
                ...
                var removeIconCross = showRemoveIcon ? React.createElement(Icon, { type: 'close', title: locale.removeFile, onClick: function onClick() {
                        return _this3.handleClose(file);
                    } }) : null;
