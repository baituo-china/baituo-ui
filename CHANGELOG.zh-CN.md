...
`baituo-ui` 严格遵循 [Semantic Versioning 2.0.0](http://semver.org/lang/zh-CN/) 语义化版本规范。
...
- 🌟 并入`baituo-ui/pro` 组件库。
- 🌟 默认ant前缀改为c7n，如要使用ant前缀，请[修改主题变量@c7n-prefix](https://baituo.github.io/baituo-ui/docs/react/customize-theme-cn)，并使用[全局化配置](https://baituo.github.io/baituo-ui/components/configure-cn)。
