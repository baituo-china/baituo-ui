...
exports.MAX_SAFE_INTEGER = undefined;
...
function getNearStepValues(value, step) {
...
function formatNumber(value, lang, options) {
    ...
    if (!isNaN(v)) {
        if (toLocaleStringSupportsLocales()) {
            return v.toLocaleString((0, _normalizeLanguage2['default'])(lang), (0, _extends3['default'])({}, getNumberFormatOptions("number" /* number */, options), options));
        } else {
...
function formatCurrency(value, lang, options) {
    ...
    if (!isNaN(v)) {
        if (toLocaleStringSupportsLocales()) {
            return v.toLocaleString((0, _normalizeLanguage2['default'])(lang), (0, _extends3['default'])({}, getNumberFormatOptions("currency" /* currency */, options), options));
        } else {
