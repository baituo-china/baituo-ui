...
var _DataSetSnapshot = require('./DataSetSnapshot');

var _DataSetSnapshot2 = _interopRequireDefault(_DataSetSnapshot);

var _confirm = require('../modal/confirm');
...
var DataSet = function (_EventManager) {
    (0, _inherits3['default'])(DataSet, _EventManager);

    function DataSet(props) {
        (0, _classCallCheck3['default'])(this, DataSet);

        var _this = (0, _possibleConstructorReturn3['default'])(this, (DataSet.__proto__ || Object.getPrototypeOf(DataSet)).call(this));

        _this.children = {};
        _this.originalData = [];
        _this.isFilteredByQueryFields = false;
        _this.inBatchSelection = false;
        _this.syncChildrenRemote = (0, _debounce2['default'])(function (remoteKeys, current) {
        ...
        (0, _mobx.runInAction)(function () {
            _this.props = props = (0, _extends3['default'])({}, DataSet.defaultProps, { dataKey: (0, _configure.getConfig)('dataKey'), totalKey: (0, _configure.getConfig)('totalKey') }, props);
            var _props = props,
                data = _props.data,
    ...
    (0, _createClass3['default'])(DataSet, [{
        ...
        value: function snapshot() {
            return new _DataSetSnapshot2['default'](this);
        }
    }, {
        key: 'restore',
        value: function restore(snapshot) {
            (0, _extends3['default'])(this, snapshot);
            return this;
        }
    }, {
        key: 'toData',
        ...
        value: function toJSONData(isSelected, noCascade) {
            ...
            (isSelected ? this.selected : this.data.concat(this.destroyed)).forEach(function (record) {
                return (0, _utils.generateJSONData)(data, record, noCascade);
            });
            return data;
        }
        /**
        ...
        key: 'ready',
        value: function () {
            var _ref = (0, _asyncToGenerator3['default'])( /*#__PURE__*/_regenerator2['default'].mark(function _callee(isSelect) {
                var pending, result;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 3;
                                return Promise.all([pending].concat((0, _toConsumableArray3['default'])((isSelect ? this.selected : this.data).map(function (record) {
                                    return record.ready();
                                })), (0, _toConsumableArray3['default'])(Array.from(this.fields.values()).map(function (field) {
                                    return field.ready();
                                }))));
        ...
        key: 'submit',
        value: function () {
            var _ref3 = (0, _asyncToGenerator3['default'])( /*#__PURE__*/_regenerator2['default'].mark(function _callee3(isSelect, noCascade) {
                    ...
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            ...
                            case 9:
                                ...
                                (0, _utils.doExport)((0, _utils.append)(exportUrl, (0, _extends3['default'])({ total: this.totalCount, _r: Date.now() }, this.generateOrderQueryString())), JSON.stringify(params));
                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            ...
                            case 8:
                                ...
                                _context5.next = 14;
                                return (0, _confirm2['default'])((0, _localeContext.$l)('DataSet', 'unsaved_data_confirm'));
        ...
        value: function create() {
            ...
            try {
                for (var _iterator = this.fields.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    if (value === void 0 && defaultValue !== void 0) {
                        ObjectChainValue.set(data, name, (0, _mobx.toJS)(defaultValue));
                    }
                }
            } catch (err) {
            ...
            var record = this.current = new _Record2['default'](data, this);
        ...
        key: 'delete',
        value: function () {
            var _ref8 = (0, _asyncToGenerator3['default'])( /*#__PURE__*/_regenerator2['default'].mark(function _callee6(records) {
                    ...
                    while (1) {
                        switch (_context6.prev = _context6.next) {
                            case 0:
                                ...
                                _context6.next = 6;
                                return (0, _confirm2['default'])((0, _localeContext.$l)('DataSet', 'delete_selected_row_confirm'));
                    ...
                    while (1) {
                        switch (_context7.prev = _context7.next) {
                            case 0:
                                ...
                                _context7.next = 4;
                                return (0, _confirm2['default'])((0, _localeContext.$l)('DataSet', 'delete_all_row_confirm'));
        ...
        value: function push() {
            ...
            (0, _utils.checkParentByInsert)(this);

            for (var _len = arguments.length, records = Array(_len), _key = 0; _key < _len; _key++) {
                records[_key] = arguments[_key];
            }

            return (_data = this.data).push.apply(_data, (0, _toConsumableArray3['default'])(this.transferRecords(records)));
        }
        /**
         * 将若干数据记录插入记录堆栈底部
         * @param records 数据集
        ...
        value: function unshift() {
            ...
            return (_data2 = this.data).unshift.apply(_data2, (0, _toConsumableArray3['default'])(this.transferRecords(records)));
        }
        /**
         * 从记录堆栈顶部获取记录
         * @return 记录
        ...
        value: function splice(from, deleteCount) {
            ...
            return (_data3 = this.data).splice.apply(_data3, [from, deleteCount].concat((0, _toConsumableArray3['default'])(this.transferRecords(records)))).map(this.deleteRecord, this);
        }
        /**
        ...
        value: function sort(fieldName) {
            ...
            if (field) {
                var currents = (0, _utils.getOrderFields)(this.fields);
                ...
                if (this.paging && this.transport.read) {
                    ...
                    this.data = this.data.sort((0, _utils.getFieldSorter)(field));
                }
            }
        }
        /**
        ...
        value: function select(recordOrIndex) {
            ...
            if (selection) {
                ...
                if ((0, _isNumber2['default'])(recordOrIndex)) {
        ...
        value: function initFields(fields) {
            ...
            fields.forEach(function (field) {
                ...
                if (name) {
                    ...
                    (0, _warning2['default'])(false, 'DataSet create field failed. Please check if property name is exists on field.');
                }
            });
        }
        /*
        ...
        value: function addField(fieldName) {
            ...
            var field = new _Field2['default'](props, this);
        ...
        value: function bind(ds, name) {
            if (!name) {
                (0, _warning2['default'])(false, 'DataSet: cascade binding need a name');
                return;
            }
            if (ds.children[name]) {
                (0, _warning2['default'])(false, 'DataSet: duplicate cascade binding of name<' + name + '>');
                return;
            }
        ...
        value: function loadData() {
            ...
            this.data = this.originalData = allData.map(function (data) {
                var record = new _Record2['default'](data, _this9);
            ...
            return records.map(function (record) {
                ...
                if (dataSet === _this10) {
                    ...
                    if (dataSet) {
                        ...
                        record = new _Record2['default'](record.data, _this10);
                    }
            ...
            if ((0, _isArray2['default'])(children)) {
                children.forEach(function (childDs) {
                    if (childDs instanceof DataSet) {
                        ...
                        if (name) {
                            ...
                            (0, _warning2['default'])(false, 'cascade DataSet need a name');
                        }
                    }
                });
            } else {
                Object.keys(children).forEach(function (childName) {
                    ...
                    if (child instanceof DataSet) {
                        ...
                        (0, _warning2['default'])(false, 'cascade child<' + childName + '> must be instance of DataSet.');
                    }
                });
            }
        }
        ...
        value: function loadDataFromResponse(resp) {
            if (resp) {
                ...
                var data = (0, _utils.generateResponseData)(resp, dataKey);
        ...
        key: 'write',
        value: function () {
            var _ref12 = (0, _asyncToGenerator3['default'])( /*#__PURE__*/_regenerator2['default'].mark(function _callee8(records, noCascade) {
                var _this13 = this;
                    ...
                    while (1) {
                        switch (_context8.prev = _context8.next) {
                            case 0:
                                ...
                                _prepareSubmitData = (0, _utils.prepareSubmitData)(records, noCascade), _prepareSubmitData2 = (0, _slicedToArray3['default'])(_prepareSubmitData, 4), created = _prepareSubmitData2[0], updated = _prepareSubmitData2[1], destroyed = _prepareSubmitData2[2], cascade = _prepareSubmitData2[3];
                                transport = this.transport;
                                axiosConfigs = [];
                                submitData = [].concat((0, _toConsumableArray3['default'])((0, _utils.prepareForSubmit)('create', created, transport, axiosConfigs, this)), (0, _toConsumableArray3['default'])((0, _utils.prepareForSubmit)('update', updated, transport, axiosConfigs, this)), (0, _toConsumableArray3['default'])((0, _utils.prepareForSubmit)('destroy', destroyed, transport, axiosConfigs, this)), (0, _toConsumableArray3['default'])(cascade));

                                (0, _utils.prepareForSubmit)('submit', submitData, transport, axiosConfigs, this);
                                ...
                                return this.fireEvent("submit" /* submit */, {
                                    dataSet: this,
                                    data: [].concat((0, _toConsumableArray3['default'])(created), (0, _toConsumableArray3['default'])(updated), (0, _toConsumableArray3['default'])(destroyed), (0, _toConsumableArray3['default'])(cascade))
                                });
                            ...
                            case 11:
                                ...
                                this.pending = _axios2['default'].all(axiosConfigs.map(function (config) {
                ...
                return _regenerator2['default'].wrap(function _callee9$(_context9) {
                    while (1) {
                        switch (_context9.prev = _context9.next) {
                            ...
                            case 6:
                                data = _context9.sent;
                                newConfig = (0, _utils.axiosAdapter)(_read, this, data, this.generateQueryString(page));
        ...
        value: function storeSelected() {
            if (this.cacheSelectionKeys) {
                this.cachedSelected = [].concat((0, _toConsumableArray3['default'])(this.cachedSelected.filter(function (record) {
                    return record.isSelected;
                })), (0, _toConsumableArray3['default'])(this.currentSelected.map(function (record) {
        ...
        value: function handleLoadFail(e) {
            ...
            _message2['default'].error((0, _exception2['default'])(e, (0, _localeContext.$l)('DataSet', 'query_failure')));
        }
    }, {
        ...
        value: function handleSubmitSuccess(resp) {
            ...
            resp.forEach(function (item) {
                data.push.apply(data, (0, _toConsumableArray3['default'])((0, _utils.generateResponseData)(item, dataKey)));
                if (totalKey && (0, _isObject2['default'])(item) && totalKey in item) {
                    total = item[totalKey];
                }
            });
            var result = dataKey ? (_ref15 = {}, (0, _defineProperty3['default'])(_ref15, dataKey, data), (0, _defineProperty3['default'])(_ref15, totalKey, total), (0, _defineProperty3['default'])(_ref15, 'success', true), _ref15) : data;
            this.fireEvent("submitSuccess" /* submitSuccess */, { dataSet: this, data: result });
            this.commitData(data, total);
            _message2['default'].success((0, _localeContext.$l)('DataSet', 'submit_success'));
            return result;
        }
    }, {
        ...
        value: function handleSubmitFail(e) {
            ...
            _message2['default'].error((0, _exception2['default'])(e, (0, _localeContext.$l)('DataSet', 'submit_failure')));
        }
    }, {
        key: 'syncChildren',
        value: function syncChildren(current, previous) {
            ...
            keys.forEach(function (childName) {
                ...
                if (current) {
                    ...
                    if (snapshot instanceof _DataSetSnapshot2['default']) {
                        ds.restore(snapshot);
                    } else {
        ...
        value: function syncChild(ds, currentRecord, childName, onlyClient) {
            ...
            if (currentRecord.status === "add" /* add */ || (0, _mobx.isArrayLike)(childRecords)) {
        ...
        value: function generateOrderQueryString() {
            ...
            var orderField = (0, _utils.getOrderFields)(fields)[0];
            if (orderField) {
                var param = { sortname: orderField.name, sortorder: orderField.order };
                if (orderField.type === "object" /* object */) {
                        var bindField = (0, _utils.findBindFieldBy)(orderField, this.fields, 'valueField');
                        if (bindField) {
        ...
        value: function generateQueryString(page) {
            ...
            var generatePageQuery = (0, _configure.getConfig)('generatePageQuery');
            ...
            return (0, _extends3['default'])({}, pageQuery, order);
        }
    }, {
                    ...
                    while (1) {
                        switch (_context10.prev = _context10.next) {
                            ...
                            case 8:
                                ...
                                throw new Error((0, _localeContext.$l)('DataSet', 'invalid_query_dataset'));
                            ...
                            case 10:
                                ...
                                data = (0, _extends3['default'])({}, data, this.queryParameter, parentParam);
        ...
        key: 'axios',
        get: function get() {
            return this.props.axios || (0, _configure.getConfig)('axios') || _axios4['default'];
        }
    }, {
        key: 'lang',
        get: function get() {
            return (0, _mobx.get)(this.props, 'lang');
        },
        set: function set(lang) {
            var _this17 = this;

            (0, _mobx.runInAction)(function () {
                (0, _mobx.set)(_this17.props, 'lang', lang);
            });
        }
    }, {
        key: 'queryDataSet',
        ...
        set: function set(ds) {
            ...
            (0, _mobx.runInAction)(function () {
                (0, _mobx.set)(_this18.props, 'queryDataSet', ds);
                if (ds) {
        ...
        key: 'queryUrl',
        get: function get() {
            return (0, _mobx.get)(this.props, 'queryUrl') || this.name && '/dataset/' + this.name + '/queries';
        }
        /**
         * 设置提交的Url.
        ...
        set: function set(url) {
            ...
            (0, _mobx.runInAction)(function () {
                (0, _mobx.set)(_this19.props, 'queryUrl', url);
            });
        }
    }, {
        key: 'submitUrl',
        get: function get() {
            return (0, _mobx.get)(this.props, 'submitUrl') || this.name && '/dataset/' + this.name + '/mutations';
        }
        /**
         * 设置查询的Url.
        ...
        set: function set(url) {
            ...
            (0, _mobx.runInAction)(function () {
                (0, _mobx.set)(_this20.props, 'submitUrl', url);
            });
        }
    }, {
        key: 'tlsUrl',
        get: function get() {
            return (0, _mobx.get)(this.props, 'tlsUrl') || this.name && '/dataset/' + this.name + '/languages';
        }
        /**
         * 设置多语言的Url.
        ...
        set: function set(url) {
            ...
            (0, _mobx.runInAction)(function () {
                (0, _mobx.set)(_this21.props, 'tlsUrl', url);
            });
        }
    }, {
        key: 'validateUrl',
        get: function get() {
            return (0, _mobx.get)(this.props, 'validateUrl') || this.name && '/dataset/' + this.name + '/validate';
        }
        /**
         * 设置远程校验查询请求的url.
        ...
        set: function set(url) {
            ...
            (0, _mobx.runInAction)(function () {
                (0, _mobx.set)(_this22.props, 'validateUrl', url);
            });
        }
    }, {
        key: 'exportUrl',
        get: function get() {
            return (0, _mobx.get)(this.props, 'exportUrl') || this.name && '/dataset/' + this.name + '/export';
        }
        /**
         * 设置导出请求的url.
         * @param {String} url 远程校验查询请求的url.
        ...
        set: function set(url) {
            ...
            (0, _mobx.runInAction)(function () {
                (0, _mobx.set)(_this23.props, 'exportUrl', url);
            });
        }
    }, {
        key: 'transport',
        set: function set(transport) {
            ...
            (0, _mobx.runInAction)(function () {
                _this24.props.transport = transport instanceof _Transport2['default'] ? transport.props : transport;
            });
        },
        get: function get() {
            return new _Transport2['default'](this.props.transport, this);
        }
        /**
         * 获取新建的记录集
         * @return 记录集
        ...
        get: function get() {
            ...
            //   return data;
            // }
            return (0, _utils.sortTree)(this.filter(function (record) {
...
tslib_1.__decorate([_mobx.observable], DataSet.prototype, "name", void 0);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "axios", null);
tslib_1.__decorate([_mobx.observable], DataSet.prototype, "fields", void 0);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "lang", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "queryUrl", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "submitUrl", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "tlsUrl", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "validateUrl", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "exportUrl", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "transport", null);
tslib_1.__decorate([_mobx.observable], DataSet.prototype, "props", void 0);
tslib_1.__decorate([_mobx.observable], DataSet.prototype, "data", void 0);
tslib_1.__decorate([_mobx.observable], DataSet.prototype, "pageSize", void 0);
tslib_1.__decorate([_mobx.observable], DataSet.prototype, "totalCount", void 0);
tslib_1.__decorate([_mobx.observable], DataSet.prototype, "status", void 0);
tslib_1.__decorate([_mobx.observable], DataSet.prototype, "currentPage", void 0);
tslib_1.__decorate([_mobx.observable], DataSet.prototype, "selection", void 0);
tslib_1.__decorate([_mobx.observable], DataSet.prototype, "destroyed", void 0);
tslib_1.__decorate([_mobx.observable], DataSet.prototype, "cachedSelected", void 0);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "created", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "updated", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "selected", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "currentSelected", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "totalPage", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "currentIndex", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "length", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "treeData", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "paging", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "current", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "uniqueKeys", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "cacheSelectionKeys", null);
tslib_1.__decorate([_mobx.computed], DataSet.prototype, "all", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "restore", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "reset", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "remove", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "removeAll", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "deleteAll", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "push", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "unshift", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "pop", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "shift", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "splice", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "reverse", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "sort", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "select", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "unSelect", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "selectAll", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "unSelectAll", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "clearCachedSelected", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "addField", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "commitData", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "loadData", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "storeSelected", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "releaseCachedSelected", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "changeStatus", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "changeSubmitStatus", null);
tslib_1.__decorate([_mobx.action], DataSet.prototype, "syncChild", null);
