...
`baituo-ui` strictly follows [Semantic Versioning 2.0.0](http://semver.org/).
...
- 🌟 Incorporate the `baituo-ui/pro` component library.
- 🌟 The default ant prefix is changed to c7n. To use the ant prefix, please [Modify the topic variable @c7n-prefix] (https://baituo.github.io/baituo-ui/docs/react/customize-theme) And use [global configuration] (https://baituo.github.io/baituo-ui/components/configure).
