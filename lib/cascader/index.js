...
var _cascader = require('../rc-components/cascader');
    ...
    (0, _createClass3['default'])(Cascader, [{
        ...
        value: function render() {
            ...
            var customizePrefixCls = props.prefixCls,
                ...
                otherProps = (0, _objectWithoutProperties3['default'])(props, ['prefixCls', 'inputPrefixCls', 'children', 'placeholder', 'size', 'disabled', 'className', 'style', 'allowClear', 'showSearch']);
            ...
            var input = children || _react2['default'].createElement(
                ...
                _react2['default'].createElement(_icon2['default'], { type: 'arrow_drop_down', className: arrowCls })
            );
            return _react2['default'].createElement(
                _cascader2['default'],
                (0, _extends3['default'])({}, props, { inputPrefixCls: inputPrefixCls, prefixCls: prefixCls, options: options, value: value, popupVisible: state.popupVisible, onPopupVisibleChange: this.handlePopupVisibleChange, onChange: this.handleChange, dropdownMenuColumnStyle: dropdownMenuColumnStyle }),
                input
            );
        }
    }]);
