...
exports['default'] = function (el, refNode, align) {
    ...
    var newElRegion = (0, _extends3['default'])(elRegion, elFuturePos);
    ...
    if (visibleRect && (overflow.adjustX || overflow.adjustY) && isTargetNotOutOfVisible) {
        ...
        if (fail) {
            ...
            (0, _extends3['default'])(newElRegion, elFuturePos);
        }
    ...
    (0, _extends3['default'])(source.style, {
        left: (0, _UnitConvertor.pxToRem)(newElRegion.left + scrollLeft),
        top: (0, _UnitConvertor.pxToRem)(newElRegion.top + scrollTop)
    });
    if (isTargetFixed) {
...
function adjustForViewport(elFuturePos, elRegion, visibleRect, overflow) {
    var pos = (0, _extends3['default'])({}, elFuturePos);
    var size = {
    ...
    return (0, _extends3['default'])(pos, size);
}
