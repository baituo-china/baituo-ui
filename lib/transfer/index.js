...
var Transfer = function (_Component) {
    ...
    function Transfer(props) {
        ...
        _this.moveTo = function (direction) {
            ...
            var moveKeys = direction === "right" /* right */ ? sourceSelectedKeys : targetSelectedKeys;
            ...
            var newTargetKeys = direction === "right" /* right */
            ? newMoveKeys.concat(targetKeys) : targetKeys.filter(function (targetKey) {
                return newMoveKeys.indexOf(targetKey) === -1;
            });
            // empty checked keys
            var oppositeDirection = direction === "right" /* right */ ? "left" /* left */ : "right" /* right */;
        ...
        _this.moveToLeft = function () {
            return _this.moveTo("left" /* left */);
        };
        _this.moveToRight = function () {
            return _this.moveTo("right" /* right */);
        };
        ...
        _this.handleLeftSelectAll = function (filteredDataSource, checkAll) {
            return _this.handleSelectAll("left" /* left */, filteredDataSource, checkAll);
        };
        _this.handleRightSelectAll = function (filteredDataSource, checkAll) {
            return _this.handleSelectAll("right" /* right */, filteredDataSource, checkAll);
        };
        ...
        _this.handleLeftFilter = function (e) {
            return _this.handleFilter("left" /* left */, e);
        };
        _this.handleRightFilter = function (e) {
            return _this.handleFilter("right" /* right */, e);
        };
        _this.handleClear = function (direction) {
            _this.setState((0, _defineProperty3['default'])({}, direction + 'Filter', ''));
        };
        _this.handleLeftClear = function () {
            return _this.handleClear("left" /* left */);
        };
        _this.handleRightClear = function () {
            return _this.handleClear("right" /* right */);
        };
        _this.handleSelect = function (direction, selectedItem, checked) {
            ...
            var holder = direction === "left" /* left */ ? [].concat((0, _toConsumableArray3['default'])(sourceSelectedKeys)) : [].concat((0, _toConsumableArray3['default'])(targetSelectedKeys));
        ...
        _this.handleLeftSelect = function (selectedItem, checked) {
            return _this.handleSelect("left" /* left */, selectedItem, checked);
        };
        _this.handleRightSelect = function (selectedItem, checked) {
            return _this.handleSelect("right" /* right */, selectedItem, checked);
        };
        ...
        _this.handleLeftScroll = function (e) {
            return _this.handleScroll("left" /* left */, e);
        };
        _this.handleRightScroll = function (e) {
            return _this.handleScroll("right" /* right */, e);
        };
        _this.renderTransfer = function (locale) {
            ...
            var prefixCls = (0, _configure.getPrefixCls)('transfer', customizePrefixCls);
