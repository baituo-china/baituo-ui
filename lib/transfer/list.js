...
function isRenderResultPlainObject(result) {
    return result && !(0, _react.isValidElement)(result) && Object.prototype.toString.call(result) === '[object Object]';
}

var TransferList = function (_Component) {
    (0, _inherits3['default'])(TransferList, _Component);

    function TransferList() {
        (0, _classCallCheck3['default'])(this, TransferList);

        var _this = (0, _possibleConstructorReturn3['default'])(this, (TransferList.__proto__ || Object.getPrototypeOf(TransferList)).apply(this, arguments));
        ...
        _this.handleFilter = function (e) {
            ...
            _this.triggerScrollTimer = window.setTimeout(function () {
                var listNode = (0, _reactDom.findDOMNode)(_this).querySelectorAll(_this.props.prefixCls + '-content')[0];
                if (listNode) {
        ...
        _this.renderItem = function (item) {
            var _this$props$render = _this.props.render,
                render = _this$props$render === undefined ? _noop2['default'] : _this$props$render;
    ...
    (0, _createClass3['default'])(TransferList, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                body = _props$body === undefined ? _noop2['default'] : _props$body,
                _props$footer = _props.footer,
                footer = _props$footer === undefined ? _noop2['default'] : _props$footer,
