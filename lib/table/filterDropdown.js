...
var FilterMenu = function (_Component) {
    (0, _inherits3['default'])(FilterMenu, _Component);
    ...
    function FilterMenu(props) {
        ...
        _this.setNeverShown = function (column) {
            var rootNode = (0, _reactDom.findDOMNode)(_this);
            var filterBelongToScrollBody = !!(0, _domClosest2['default'])(rootNode, _this.props.prefixCls + '-scroll');
        ...
        _this.handleFilterDropdownMenuClick = function (e) {
            e.preventDefault();
        };
        ...
        _this.renderFilterIcon = function () {
            ...
            return filterIcon ? (0, _react.cloneElement)(filterIcon, {
                title: locale.filterTitle,
                className: (0, _classnames2['default'])(filterIcon.className, (0, _defineProperty3['default'])({}, prefixCls + '-icon', true))
            }) : _react2['default'].createElement(_icon2['default'], { title: locale.filterTitle, type: 'filter_list', className: dropdownSelectedClass });
        };
    ...
    (0, _createClass3['default'])(FilterMenu, [{
        ...
        value: function renderMenuItem(item) {
            ...
            var multiple = 'filterMultiple' in column ? column.filterMultiple : false;
            var input = multiple ? null : _react2['default'].createElement(_radio2['default'], { checked: this.state.selectedKeys.indexOf(item.value.toString()) >= 0 });
        ...
        value: function render() {
            ...
            var menus = column.filterDropdown ? _react2['default'].createElement(
                ...
                _FilterDropdownMenuWrapper2['default'],
                { className: prefixCls + '-dropdown', onClick: this.handleFilterDropdownMenuClick },
                _react2['default'].createElement(
                    _menu2['default'],
