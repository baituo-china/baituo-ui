...
var Step = function (_Component) {
  ...
  (0, _createClass3['default'])(Step, [{
    ...
    value: function renderIconNode() {
      ...
      var iconNode = void 0;
      var iconClassName = (0, _classnames2['default'])('' + iconPrefix, (_classNames = {}, (0, _defineProperty3['default'])(_classNames, iconPrefix + '-' + icon, icon && isString(icon)), (0, _defineProperty3['default'])(_classNames, iconPrefix + '-check', !icon && status === 'finish'), (0, _defineProperty3['default'])(_classNames, iconPrefix + '-close', !icon && status === 'error'), _classNames));
