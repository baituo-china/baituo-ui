...
var MentionContentComponent = function MentionContentComponent(props) {
  ...
  return (0, _react.createElement)(tag, (0, _extends3['default'])({}, props, { data: data }));
};
...
function createMention() {
  ...
  var callbacks = {
    ...
    onUpArrow: _noop2['default'],
    onDownArrow: _noop2['default'],
    getEditorState: _noop2['default'],
    setEditorState: _noop2['default'],
    handleReturn: _noop2['default'],
