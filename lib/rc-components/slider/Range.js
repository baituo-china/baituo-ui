...
var Range = function (_Component) {
  ...
  (0, _createClass3['default'])(Range, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (this.props.min === nextProps.min && this.props.max === nextProps.max && (0, _isEqual2['default'])(this.props.value, nextProps.value)) {
        return;
      }
  ...
  return Range;
}(_react.Component); /* eslint-disable react/prop-types */
