...
var Pagination = function (_Component) {
  ...
  function Pagination(props) {
    ...
    var hasOnChange = props.onChange !== _noop2['default'];
  ...
  (0, _createClass3['default'])(Pagination, [{
    ...
    value: function render() {
      ...
      if (props.simple) {
        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            props.itemRender(prevPage, 'prev', _react2['default'].createElement('a', { className: prefixCls + '-item-link' }), !this.hasPrev(), 'small')
          ),
          _react2['default'].createElement(
            'li',
            {
          ...
          _react2['default'].createElement(
            ...
            props.itemRender(nextPage, 'next', _react2['default'].createElement('a', { className: prefixCls + '-item-link' }), !this.hasNext(), 'small')
          ),
          gotoButton
        );
      }
      ...
      if (allPages <= 5 + pageBufferSize * 2) {
        ...
        if (props.showPrevNextJumpers) {
          jumpPrev = _react2['default'].createElement(
            ...
            props.itemRender(this.getJumpPrevPage(), 'jump-prev', _react2['default'].createElement(
              'a',
          ...
          jumpNext = _react2['default'].createElement(
            ...
            props.itemRender(this.getJumpNextPage(), 'jump-next', _react2['default'].createElement(
              'a',
              { className: prefixCls + '-item-link' },
              '\u2022\u2022\u2022'
            ), props.size)
      ...
      if (props.tiny) {
        ...
        firstPager = _react2['default'].createElement(
          'li',
          {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          props.itemRender(prevPage, 'prev', _react2['default'].createElement('a', { className: prefixCls + '-item-link' }), prevDisabled, props.size)
        ),
        ...
        _react2['default'].createElement(
          ...
          props.itemRender(nextPage, 'next', _react2['default'].createElement('a', { className: prefixCls + '-item-link' }), nextDisabled, props.size)
        ),
