...
var MenuItemGroup = function (_Component) {
  ...
  function MenuItemGroup() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3['default'])(this, (_ref = MenuItemGroup.__proto__ || Object.getPrototypeOf(MenuItemGroup)).call.apply(_ref, [this].concat(args))), _this), _this.renderInnerMenuItem = function (item) {
