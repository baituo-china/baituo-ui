...
var SubMenu = exports.SubMenu = function (_Component) {
    ...
    value: function render() {
      ...
      if (props.mode !== 'horizontal') {
        ...
        if (typeof this.props.expandIcon === 'function') {
          icon = (0, _react.createElement)(this.props.expandIcon, (0, _extends4['default'])({}, this.props));
        }
      }
...
SubMenu.defaultProps = {
  ...
  onTitleMouseEnter: _noop2['default'],
  onTitleMouseLeave: _noop2['default'],
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.adjustWidth = function () {
    ...
    var popupMenu = (0, _reactDom.findDOMNode)(_this3.menuInstance);
