...
var BaseTable = function (_Component) {
  (0, _inherits3['default'])(BaseTable, _Component);
  ...
  (0, _createClass3['default'])(BaseTable, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        body,
        hasFoot && _react2['default'].createElement(_TableFooter2['default'], { onHover: this.handleRowHover, columns: columns, fixed: fixed })
      );
    }
  }]);
  return BaseTable;
...
BaseTable.propTypes = {
  ...
  hasFoot: _propTypes2['default'].bool.isRequired,
