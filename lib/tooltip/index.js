...
var _tooltip = require('../rc-components/tooltip');
...
var Tooltip = function (_Component) {
    ...
    (0, _createClass3['default'])(Tooltip, [{
        ...
        value: function render() {
            ...
            var child = this.getDisabledCompatibleChildren((0, _react.isValidElement)(children) ? children : _react2['default'].createElement(
                'span',
                null,
                children
            ));
            ...
            return _react2['default'].createElement(
                _tooltip2['default'],
                (0, _extends3['default'])({}, this.props, { prefixCls: prefixCls, getTooltipContainer: getPopupContainer || getTooltipContainer, ref: this.saveTooltip, builtinPlacements: this.getPlacements(), overlay: overlay || title || '', visible: visible, onVisibleChange: this.onVisibleChange, onPopupAlign: this.onPopupAlign }),
