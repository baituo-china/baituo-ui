...
var Menu = function (_Component) {
    ...
    (0, _createClass3['default'])(Menu, [{
        ...
        value: function getPrefixCls() {
            return (0, _configure.getPrefixCls)('menu', this.props.prefixCls);
        }
    }, {
        ...
        value: function componentWillReceiveProps(nextProps, nextContext) {
            ...
            if (nextProps.inlineCollapsed && !inlineCollapsed || nextContext.siderCollapsed && !siderCollapsed) {
                this.switchModeFromInline = !!openKeys.length && !!(0, _reactDom.findDOMNode)(this).querySelectorAll('.' + this.getPrefixCls() + '-submenu-open').length;
            ...
            if (openAnimation === undefined && openTransitionName === undefined) {
                switch (menuMode) {
                    ...
                    case 'vertical-right':
                        ...
                        break;
                    case 'inline':
                        menuOpenAnimation = (0, _extends3['default'])({}, _openAnimation2['default'], {
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(_menu2['default'], (0, _extends3['default'])({}, this.props, menuProps, { prefixCls: prefixCls }));
        }
    }]);
    return Menu;
}(_react.Component);
