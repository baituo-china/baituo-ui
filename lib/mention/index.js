...
var _editorMention = require('../rc-components/editor-mention');

var _editorMention2 = _interopRequireDefault(_editorMention);
...
var Mention = function (_Component) {
    (0, _inherits3['default'])(Mention, _Component);
    ...
    (0, _createClass3['default'])(Mention, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            if (!(0, _isEqual2['default'])(suggestions, this.props.suggestions)) {
                this.setState({
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(_editorMention2['default'], (0, _extends3['default'])({}, this.props, { prefixCls: prefixCls, className: cls, ref: this.mentionRef, onSearchChange: this.onSearchChange, onChange: this.onChange, onFocus: this.onFocus, onBlur: this.onBlur, suggestions: suggestions, notFoundContent: notFoundContent }));
        }
    }]);
    return Mention;
}(_react.Component);
