...
var Modal = function (_Component) {
    ...
    (0, _createClass3['default'])(Modal, [{
        ...
        value: function render() {
            ...
            var prefixCls = (0, _configure.getPrefixCls)('modal', customizePrefixCls);
            var defaultFooter = _react2['default'].createElement(
                _LocaleReceiver2['default'],
                { componentName: 'Modal', defaultLocale: (0, _locale.getConfirmLocale)() },
                this.renderFooter
            );
            return _react2['default'].createElement(_dialog2['default'], (0, _extends3['default'])({}, this.props, { prefixCls: prefixCls, footer: footer === undefined ? defaultFooter : footer, visible: visible, mousePosition: mousePosition, onClose: this.handleCancel }));
        }
    }]);
    return Modal;
}(_react.Component);
