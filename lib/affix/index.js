...
var Affix = function (_Component) {
    ...
    (0, _createClass3['default'])(Affix, [{
        ...
        value: function setAffixStyle(e, affixStyle) {
            ...
            if ((0, _isEqual2['default'])(affixStyle, originalAffixStyle)) {
                return;
            }
        ...
        value: function setPlaceholderStyle(placeholderStyle) {
            ...
            if ((0, _isEqual2['default'])(placeholderStyle, originalPlaceholderStyle)) {
                return;
            }
        ...
        value: function render() {
            ...
            var className = (0, _classnames2['default'])((0, _defineProperty3['default'])({}, (0, _configure.getPrefixCls)('affix', prefixCls), affixStyle));
            var props = (0, _omit2['default'])(this.props, ['prefixCls', 'offsetTop', 'offsetBottom', 'target', 'onChange']);
            return _react2['default'].createElement(
                'div',
                (0, _extends3['default'])({}, props, { style: (0, _extends3['default'])({}, placeholderStyle, style), ref: this.savePlaceholderNode }),
...
tslib_1.__decorate([(0, _throttleByAnimationFrame.throttleByAnimationFrameDecorator)()], Affix.prototype, "updatePosition", null);
