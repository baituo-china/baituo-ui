    ...
    (0, _createClass3['default'])(UploadList, [{
        ...
        value: function render() {
            ...
            var list = items.map(function (file) {
                ...
                var progress = void 0;
                var icon = _react2['default'].createElement(_icon2['default'], { type: file.status === 'uploading' ? 'loading' : 'attach_file' });
                if (listType === 'picture' || listType === 'picture-card') {
                    if (listType === 'picture-card' && file.status === 'uploading') {
                        ...
                        var thumbnail = isImageUrl(file.thumbUrl || file.url) ? _react2['default'].createElement('img', { src: file.thumbUrl || file.url, alt: file.name }) : _react2['default'].createElement(_icon2['default'], { type: 'file', style: { fontSize: 48, color: 'rgba(0,0,0,0.5)' } });
                        icon = _react2['default'].createElement(
                            'a',
                ...
                if (file.status === 'uploading') {
                    ...
                    var loadingProgress = 'percent' in file ? _react2['default'].createElement(_progress2['default'], (0, _extends3['default'])({ type: "line" /* line */ }, _this3.props.progressAttr, { percent: file.percent })) : null;
                ...
                var previewIcon = showPreviewIcon ? _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(_icon2['default'], { type: 'visibility' })
                ) : null;
