...
var MiniSelect = function (_Component) {
    (0, _inherits3['default'])(MiniSelect, _Component);
    ...
    (0, _createClass3['default'])(MiniSelect, [{
        ...
        value: function render() {
            return _react2['default'].createElement(_select2['default'], (0, _extends3['default'])({ size: "small" /* small */ }, this.props));
        }
    }]);
    return MiniSelect;
}(_react.Component);
